            ...
            <View
              ...
              style={{
                ...
                background: type === typeVal
                  ? (typeVal === 'INCOME' ? 'rgba(34,197,94,0.15)' : 'rgba(255,77,90,0.15)')
                  : C.surface2,
                border: type === typeVal
                  ? `1.5px solid ${typeVal === 'INCOME' ? 'rgba(34,197,94,0.4)' : 'rgba(255,77,90,0.4)'}`
                  : `1px solid ${C.border}`,
              }}
            >
              <Text style={{
          ...
          {CATEGORIES.map(c => (
            <View
              ...
              style={{
                ...
                border: `1.5px solid ${category === c ? 'rgba(34,197,94,0.4)' : C.border}`,
